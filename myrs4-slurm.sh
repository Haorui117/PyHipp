...
DPT.objects.processDirs(dirs=['sessioneye/array04','session01/array01'], cmd='import PyHipp as pyh; import DataProcessingTools as DPT; DPT.objects.processDirs(None, pyh.RPLLFP, saveLevel=1); DPT.objects.processDirs(None, pyh.RPLHighPass, saveLevel=1);'); \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:605134426873:awsnotify --message "rs4JobDone"
